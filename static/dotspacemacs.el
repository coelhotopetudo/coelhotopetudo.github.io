...
you should place your code here."
  ...
  (spacemacs/set-leader-keys-for-major-mode 'python-mode "y" 'coelhotopetudo/zpyex)
  ...
  (spacemacs/set-leader-keys "ym" 'coelhotopetudo/zcedmatudo)
  (spacemacs/set-leader-keys "yp" 'coelhotopetudo/zpyex)
  (spacemacs/set-leader-keys "ys" 'coelhotopetudo/zcedsave)
